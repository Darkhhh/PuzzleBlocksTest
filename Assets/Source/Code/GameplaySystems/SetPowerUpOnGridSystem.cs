...
namespace Source.Code.GameplaySystems
{
    public class SetPowerUpOnGridSystem : IEcsRunSystem
    {
        ...
        private readonly EcsFilterInject<Inc<ShouldBeRemovedFigureComponent, PuzzleFigureComponent, FigurePowerUpComponent>> _removingFigureWithPowerUpFilter = default;
